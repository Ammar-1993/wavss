...
if(file_exists($fileName))
{
	...
	$email_from = "wavss@gmail.com"; // Who the email is from, don't think this does anything
	$email_subject = "WAVSS Detailed Report"; // The Subject of the email 
	$email_message = "Hello $username,<br><br>";
	$email_message .= 'Thank you for scanning with WAVSS. Please find the scan results attached in the PDF report.<br><br>';
