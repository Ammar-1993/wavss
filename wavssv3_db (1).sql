...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2025 at 07:23 AM
...
INSERT INTO `tests` (`id`, `status`, `numUrlsFound`, `type`, `num_requests_sent`, `start_timestamp`, `finish_timestamp`, `scan_finished`, `url`, `username`, `urls_found`) VALUES
(7, 'Scan is complete! The report has been emailed to you and is also in your scan history.', 1, 'scan', 123, 1742756943, 1742757143, b'1', 'https://maharatech.gov.eg/', 'Ammar', 'https://maharatech.gov.eg/<br>');
...
INSERT INTO `test_results` (`test_id`, `type`, `method`, `url`, `attack_str`) VALUES
(7, 'autoc', 'get', 'https://maharatech.gov.eg/', 'password'),
(7, 'sslcert', 'get', 'https://maharatech.gov.eg/', 'https://maharatech.gov.eg/'),
(7, 'basqli', 'post', 'https://maharatech.gov.eg/https://maharatech.gov.eg/login/index.php', 'username=1\'or\'1\'=\'1&password=1\'or\'1\'=\'1&rememberusername='),
(7, 'basqli', 'get', 'https://maharatech.gov.eg/https://maharatech.gov.eg/search/index.php?q=1\'or\'1\'=\'1&=', 'q=1\'or\'1\'=\'1&='),
(7, 'basqli', 'get', 'https://maharatech.gov.eg/https://maharatech.gov.eg/course/search.php?q=1\'or\'1\'=\'1', 'q=1\'or\'1\'=\'1');
...
('Ammar', '333f67e4b8163403b6c8bea12e5a780ac738d6e6', 'ammar@gmail.com');
...
ALTER TABLE `tests`
  ...
  ADD UNIQUE KEY `finish_timestamp_2` (`finish_timestamp`),
  ADD UNIQUE KEY `id_5` (`id`),
  ADD UNIQUE KEY `start_timestamp_4` (`start_timestamp`),
  ADD UNIQUE KEY `finish_timestamp_4` (`finish_timestamp`),
  ADD UNIQUE KEY `id_7` (`id`),
  ADD UNIQUE KEY `start_timestamp_6` (`start_timestamp`),
  ADD UNIQUE KEY `finish_timestamp_6` (`finish_timestamp`),
  ADD KEY `id_2` (`id`),
...
ALTER TABLE `vulnerabilities`
  ...
  ADD UNIQUE KEY `priority_num` (`priority_num`),
  ADD UNIQUE KEY `priority_num_3` (`priority_num`),
  ADD UNIQUE KEY `priority_num_5` (`priority_num`),
  ADD KEY `priority_num_2` (`priority_num`),
  ADD KEY `priority_num_4` (`priority_num`),
  ADD KEY `priority_num_6` (`priority_num`);
COMMIT;
